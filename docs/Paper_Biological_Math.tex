...
\hline
\textbf{Simulation Ticks} & \textbf{Phase Coherence ($R$)} & \textbf{System Entropy ($H$)} & \textbf{Status} \\ \hline
0    & 0.12 & 4.88 & Initializing \\ \hline
250  & 0.45 & 3.52 & Synchronizing \\ \hline
500  & 0.78 & 2.15 & Resonant \\ \hline
750  & 0.92 & 1.10 & Stable \\ \hline
1000 & 0.95 & 0.98 & Homeostatic \\ \hline
\end{tabular}
\caption{Simulated Phase Coherence and Entropy over 1000 ticks}
\label{tab:metrics}
\end{table}
...
\section*{References}
\begin{enumerate}
\item Hodgkin, A. L., \& Huxley, A. F. (1952). A quantitative description of membrane current and its application to conduction and excitation in nerve.
\item FitzHugh, R. (1961). Impulses and physiological states in theoretical models of nerve membrane.
\item Uhlenbeck, G. E., \& Ornstein, L. S. (1930). On the theory of the Brownian motion.
\end{enumerate}
