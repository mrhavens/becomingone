...
\item McGilchrist, I. (2009). \textit{The Master and His Emissary}. Yale University Press.
\item Kuramoto, Y. (1975). Self-entrainment of a population of coupled non-linear oscillators.
\item Jacobs, R. A., et al. (1991). Adaptive mixtures of local experts. \textit{Neural Computation}.
\end{enumerate}
