...
\title{\textbf{The Chorus: Grounding the Society of Mind through Continuous Phase Integration}}
\author{}
\date{}
...
\section{The Result: Continuous Phase Integration}
...
\begin{equation}
U(t) = \int_{t-\tau}^{t} \Phi(s_1(t'), s_2(t'), \dots, s_n(t')) \, dt'
\end{equation}
...
\bibitem{mcgilchrist2009}
McGilchrist, I. (2009). \textit{The Master and His Emissary: The Divided Brain and the Making of the Western World}. Yale University Press.
\end{thebibliography}
